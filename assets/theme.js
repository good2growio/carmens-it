...
//         }
          ...
          url:'/products/'+product.handle+'.js',
           ...
           dataType:'json',
                ...
                if(productResponse.variants.length > 0){
                  image = productResponse.variants[0].featured_media.preview_image.src;
                }
                }
        });
  ...
  theme.Photoswipe = (function() {
    ...
    Photoswipe.prototype = Object.assign({}, Photoswipe.prototype, {
     ...
     var image = evt.currentTarget;
       var index = document.querySelector('.cstm-main-media.slick-slide.slick-active .product-main-slide.secondary-slide').getAttribute("data-index");  
  ...
  var i = 0 ;
      var  first_items= [];  
        ...
        if(first_items.length > 0 ){
            items.push(first_items);
        }
  ...
  theme.Product = (function() {
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      updateCartButton: function(evt) {
        ...
        var soldOutBadge = document.querySelector('.cstm_soldout');
        var variantLimitedBadge = document.querySelector('.variant-limited-wrapper');
        ...
        if (variant) {
          if (variant.available) {
            ...
            if (soldOutBadge && !soldOutBadge.classList.contains('hide')) {
              soldOutBadge.classList.add('hide');
            }

            if (variantLimitedBadge && variantLimitedBadge.classList.contains('hide')) {
              variantLimitedBadge.classList.remove('hide');
            }
            ...
            console.log(soldOutBadge);
            if (soldOutBadge && soldOutBadge.classList.contains('hide')) {
              soldOutBadge.classList.remove('hide');
            }

            if (variantLimitedBadge) {
              variantLimitedBadge.classList.add('hide');
            }
          }
        } else {
      ...
      updateSku: function(evt) {
        ...
        if (variant) {
          if (variant.sku) {
            newSku = variant.sku;
            var skuArray = newSku.split("_");
          }
          
          
  
          this.container.querySelector(this.selectors.sku).textContent = skuArray[0];
        }
      },
      ...
      initImageZoom: function() {
        ...
        container.addEventListener('photoswipe:afterChange', function(evt) {
          if (this.slick) {
            this.slick.goToSlide(evt.detail.index);
          }
        }.bind(this));
      },
      ...
      updateVariantImage: function(evt) {
        ...
        if (this.slickj) {
          this.slick.goToSlide(imageIndex);
        }
      },
